<x-filament-panels::page>
    ...
    <h3 class="text-lg font-semibold mb-3">Wallet Transaction History</h3>
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                @empty
                <tr><td colspan="4" class="p-6 text-center text-gray-400">No transactions yet.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>

    <h3 class="text-lg font-semibold mt-6 mb-3">Withdrawal History</h3>
    <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
        <table class="w-full text-sm">
            <thead class="bg-gray-50">
                <tr>
            ...
            <tbody>
                    ...
                    <td class="p-3">
                        @php
                            $statusMap = [
                                ...
                                'processed' => ['bg-green-100 text-green-700', 'Processed'],
                ...
                @empty
                <tr><td colspan="4" class="p-6 text-center text-gray-400">No withdrawals yet.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
